  ...
  return (
    <footer className="bg-gray-800 text-gray-300 border-t border-gray-700 mt-12">
      <div className="container mx-auto px-4 sm:px-6 md:px-12 py-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="flex space-x-4 justify-start md:justify-center">
              <a href="https://web.facebook.com/aime.ineza.399" className="text-gray-400 hover:text-blue-400 transition-colors p-1 rounded-full bg-gray-900 hover:bg-gray-700">
                <Facebook size={24} />
              </a>
              <a href="https://x.com/AimINEZA2" className="text-gray-400 hover:text-blue-400 transition-colors p-1 rounded-full bg-gray-900 hover:bg-gray-700">
                <X size={24} />
              </a>
              <a href="https://www.instagram.com/fab_ineza/" className="text-gray-400 hover:text-blue-400 transition-colors p-1 rounded-full bg-gray-900 hover:bg-gray-700">
                <Instagram size={24} />
              </a>
              <a href="https://www.youtube.com/@Netflix" className="text-gray-400 hover:text-blue-400 transition-colors p-1 rounded-full bg-gray-900 hover:bg-gray-700">
                <Youtube size={24} />
              </a>
            </div>
          </div>
        ...
        {/* Bottom Bar */}
        <div className="mt-8 pt-6 border-t border-gray-700 text-sm flex flex-col sm:flex-row sm:justify-between items-center gap-2">
          <p className="text-center sm:text-left">&copy; {currentYear} cineView. All rights reserved.</p>
          <div className="flex items-center gap-3 text-gray-400">
            <small className="hidden sm:inline">Built by INEZA.</small>
          </div>
        </div>
      </div>
    </footer>
